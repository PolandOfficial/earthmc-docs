...
* **Police** might add users to the town outlaw list with `/t outlaw add <player>`.
...
| /t leave                                               | Leave your shithole of a town                 |
...
| [/t claim](https://earthmc.net/docs/how-to-claim-land) | Claim chunks for 16 gold each                 |
...
Towns automatically get deleted after 5 days of inactivity if no single resident has joined the server in that period of time.
