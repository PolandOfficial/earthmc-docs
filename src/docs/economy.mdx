...
### Stock exchanges
Stock exchanges are extremely reccomended for newcomers. Although it is not officially supported with the system, it is still the best way to make gold, & players can make thousands of gold every day!
